...
// Configuration EmailJS utilisant les variables d'environnement
const EMAIL_CONFIG = {
  serviceId: import.meta.env.VITE_EMAILJS_SERVICE_ID || "service_cipfaro",
  templateId: {
    candidatureRecue:
      import.meta.env.VITE_EMAILJS_TEMPLATE_CANDIDATURE ||
      "template_candidature",
    offreRecue: import.meta.env.VITE_EMAILJS_TEMPLATE_OFFRE || "template_offre",
    matching:
      import.meta.env.VITE_EMAILJS_TEMPLATE_MATCHING || "template_matching",
    inscription:
      import.meta.env.VITE_EMAILJS_TEMPLATE_INSCRIPTION ||
      "template_inscription",
    devis: import.meta.env.VITE_EMAILJS_TEMPLATE_DEVIS || "template_devis",
  },
