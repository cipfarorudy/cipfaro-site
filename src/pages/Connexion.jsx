...
export default function Connexion() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const testAccounts = {
        'admin@cipfaro-formations.com': { password: 'admin123', role: 'admin' },
        'formateur@cipfaro-formations.com': { password: 'formateur123', role: 'formateur' },
        'stagiaire@cipfaro-formations.com': { password: 'stagiaire123', role: 'stagiaire' }
      }
