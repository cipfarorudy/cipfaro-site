      ...
      <footer>
        <div className="container" style={{display:'flex', gap:'1rem', flexWrap:'wrap', justifyContent:'space-between', alignItems:'center'}}>
          <div style={{display:'flex', gap:'.8rem', alignItems:'center'}}>
            ...
            <a href="https://www.cofrac.fr" target="_blank" rel="noopener noreferrer" title="Certification ICPF / Cofrac">
              <img src={icpfMark} alt="ICPF certification" className="icpf-mark" loading="lazy" width="120" height="40" />
            </a>
          </div>
